<template>
  <div class="d8-list">
    <div class="head-b">
      <AppBreadcrumb />
      <h1>8D 报告</h1>
      <el-button size="small" v-if="canCfgAudit" @click="router.push('/system/audit-config')">审核配置</el-button>
    </div>
    ...
    <el-card shadow="never" class="card-b">
      <div style="margin-bottom:12px"><el-button type="primary" v-if="canCreate8d" @click="dialogVisible=true">+ 创建 8D</el-button></div>
      <el-table :data="list" v-loading="loading" size="small">
        ...
        <el-table-column label="操作" width="100" fixed="right">
          <template #default="{row}">
            ...
            <el-button link type="warning" size="small" v-if="canCreate8d" @click="openAssign(row as Qms8dReport)">改派</el-button>
          </template>
        </el-table-column>
      </el-table>
...
const canCfgAudit = computed(() => perm.has('system.audit-config'))
const canCreate8d = computed(() => perm.has('ncm.8d.create'))
